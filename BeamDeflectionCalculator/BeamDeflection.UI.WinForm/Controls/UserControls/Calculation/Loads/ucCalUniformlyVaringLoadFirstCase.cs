...
{
    public partial class ucCalUniformlyVaringLoadFirstCase : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalUniformlyVaringLoadFirstCase(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void ucCalUniformlyVaringLoadFirstCase_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseSecond.UniformlyVaringLoadCaseFirst(w, L, E, I)/1000;

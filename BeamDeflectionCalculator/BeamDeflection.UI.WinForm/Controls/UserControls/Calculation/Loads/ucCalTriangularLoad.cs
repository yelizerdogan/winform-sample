...
{
    public partial class ucCalTriangularLoad : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalTriangularLoad(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void ucCalTriangularLoad_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseFirst.TringularLoad(w, L, E, I) / 1000;

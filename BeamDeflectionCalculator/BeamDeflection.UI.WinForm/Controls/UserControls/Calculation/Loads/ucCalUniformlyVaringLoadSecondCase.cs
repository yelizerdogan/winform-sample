...
{
    public partial class ucCalUniformlyVaringLoadSecondCase : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalUniformlyVaringLoadSecondCase(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void ucCalUniformlyVaringLoadSecondCase_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseSecond.UniformlyVaringLoadCaseSecond(w, L, E, I) / 1000;

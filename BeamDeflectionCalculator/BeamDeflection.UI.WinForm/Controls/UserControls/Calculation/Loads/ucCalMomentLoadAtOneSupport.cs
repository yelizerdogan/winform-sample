...
{
    public partial class ucCalMomentLoadAtOneSupport : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalMomentLoadAtOneSupport(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void ucCalMomentLoadAtOneSupport_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseFirst.MomentLoadAtOneSupport(M, L, E, I)/1000;

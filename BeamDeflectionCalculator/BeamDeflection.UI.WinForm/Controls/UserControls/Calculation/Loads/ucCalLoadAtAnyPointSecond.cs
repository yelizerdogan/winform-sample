...
{
    public partial class ucCalLoadAtAnyPointSecond : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalLoadAtAnyPointSecond(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseSecond.LoadAtAnyPoint(L, a, b, P, E, I);
        ...
        private void ucCalLoadAtAnyPointSecond_Load(object sender, EventArgs e)
        {
            try
            {

...
{
    public partial class ucCalUniformlyVaring : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalUniformlyVaring(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseFirst.UniformlyVaringLoad(w, L, E, I)/1000;
        ...
        private void ucCalUniformlyVaring_Load(object sender, EventArgs e)
        {
            try
            {

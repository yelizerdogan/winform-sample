...
{
    public partial class ucCalEndLoad : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalEndLoad(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void ucCalEndLoad_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseSecond.EndLoad(L, P, E, I);

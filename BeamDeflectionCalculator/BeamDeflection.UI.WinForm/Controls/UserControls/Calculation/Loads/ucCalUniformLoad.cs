...
{
    public partial class ucCalUniformLoad : UserControl
    {
        public ApplicationUser CurrentUser { get; set; }
        public Load _Load { get; set; }
        public Unit ResultUnit { get; set; }
        public ucCalUniformLoad(ApplicationUser currentUser, Load load)
        {
            _Load = load;
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            double result = CalculateCaseFirst.UniformLoad(L, w, E, I)/1000;
        ...
        private void ucCalUniformLoad_Load(object sender, EventArgs e)
        {
            try
            {
